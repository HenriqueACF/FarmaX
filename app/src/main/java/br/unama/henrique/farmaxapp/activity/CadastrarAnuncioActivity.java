...
import br.unama.henrique.farmaxapp.helper.Permissoes;
...
public class CadastrarAnuncioActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void salvarAnuncio(){
        ...
        dialog = new SpotsDialog.Builder().setContext(this).setMessage("Salvando Anúncio... Aguarde!").setCancelable(false).build();
        dialog.show();
    ...
    private void salvarFotoStorage(String urlString, final int totalFotos, int contador){
        ...
        //Criar nó no Storage
        StorageReference imagemAnuncio = storage.child("imagens").child("anuncios").child("anuncio " + anuncio.getIdAnuncio() ).child("imagem" + contador);
    ...
    public void validarDadosAnuncio(View view){
        ...
        if (listaFotosRecuperadas.size() !=0 ){
            if (!anuncio.getEstado().isEmpty()){
                    ...
                    if (!anuncio.getTitulo().isEmpty()){
                        if (!valor.isEmpty() && !valor.equals("0")){
                            if (!anuncio.getTelefone().isEmpty() ){
                                ...
                                exibirMensagemErro("Preencha o campo Telefone: (DDD + Número!)");
                            }
                        }else{
                ...
                exibirMensagemErro("Selecione o bairro!");
            }
        }else{
    ...
    private void inicializarComponentes(){
        ...
        //Configuração Local para pt_BR -> Brasil
